-- ClickHouse Multi-Tenant Shared Tables Schema (No Partitioning)
-- Implements shared tables with tenant_id as primary sort key for multi-tenant SaaS
...
-- Note: ClickHouse doesn't have built-in RLS, so this is implemented in application layer
...
-- =============================================================================
-- MATERIALIZED VIEWS FOR ANALYTICS (No Partitioning)
-- =============================================================================
