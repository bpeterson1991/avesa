...
class Environment:
    ...
    def _load_config(cls) -> Dict[str, Any]:
        ...
        if cls._config_cache is None:
            ...
            possible_paths = [
                # Lambda deployment - local copy in function directory
                os.path.join(os.getcwd(), "environment_config.json"),
                # Development - relative to this module
                os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "infrastructure", "environment_config.json")),
                # Alternative Lambda location
                "/var/task/environment_config.json",
                # CDK deployment location
                "/var/infrastructure/environment_config.json"
            ]
            ...
            if not config_loaded:
                raise FileNotFoundError(
                    f"Environment configuration file not found at any of these locations: {possible_paths}. "
                    f"Please ensure environment_config.json exists in one of these locations."
                )
