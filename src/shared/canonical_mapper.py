...
class CanonicalMapper:
    ...
    def get_default_mapping(self, table_type: str) -> Dict[str, Any]:
        ...
        default_mappings = {
            'companies': {
                'id_field': 'id',
                'fields': {
                    'id': 'CompanyID',  # Map from ConnectWise CompanyID field
                    'company_id': 'CompanyID',  # Keep for backward compatibility
                    'name': 'CompanyName',  # Map from ConnectWise CompanyName field
                    'created_date': 'DateCreated',  # Map from test data
            ...
            'contacts': {
                ...
                'fields': {
                    ...
                    'last_name': 'lastName',
                    'email': 'communicationItems__0__value',
    ...
    def transform_record(self, raw_record: Dict[str, Any], mapping: Dict[str, Any],
                        canonical_table: str) -> Optional[Dict[str, Any]]:
        """
