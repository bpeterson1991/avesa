...
class TenantConfig(BaseModel):
    ...
    connectwise_url: str = Field(..., description="Service API base URL")
...
class ServiceConfig(BaseModel):
    ...
    service_name: str = Field(..., description="Service name (connectwise, servicenow, etc.)")
    enabled: bool = Field(default=True, description="Whether service is enabled")
    api_url: str = Field(..., description="Service API base URL")
    tables: list[str] = Field(default_factory=list, description="List of tables/endpoints to sync")
    custom_config: Optional[dict] = Field(default=None, description="Service-specific configuration")
